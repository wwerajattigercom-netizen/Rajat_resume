...
export async function downloadRajatResume() {
  ...
  const bullets1 = [
    ...
    'Designed and implemented secure, high-performance APIs integrating LLM context channels (Model Context Protocol) with SAP environments, bringing modern AI capabilities into ERP enterprise systems.',
    'Delivered 100+ user stories, resolved 170+ complex legacy defects, and managed 250+ tasks using Agile SCRUM and JIRA with zero-downtime production deployments.',
    'Optimized large-scale data processing paths using advanced clustering, hashing, and parallel cursor techniques, successfully achieving up to 90% faster retrieval.',
    'Collaborated with international functional consultants to engineer custom ABAP solutions and prepared comprehensive, professional technical specification sheets for junior developers.'
  ];
